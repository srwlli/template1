          ...
          <Card className="border-blue-200 bg-blue-50">
            <CardHeader>
              <div className="flex items-center">
                ...
                <CardTitle className="ml-3 text-sm font-medium text-blue-800">
                  Verify Your Email
                </CardTitle>
              </div>
            </CardHeader>
            <CardContent className="pt-0">
              ...
              <div className="mt-4">
                <button
                  ...
                  disabled={loading}
                  className="text-sm bg-blue-100 text-blue-800 hover:bg-blue-200 px-3 py-1 rounded font-medium disabled:opacity-50 transition-colors"
                >
